...
checkpoint_dir = './result_auto_Sony_v2/'
result_dir = './result_auto_Sony_v2/'
...
allfolders = glob.glob('./result_auto_Sony_v2/*0')
lastepoch = 0
...
for epoch in range(lastepoch, 4001):
    ...
    if os.path.isdir("result_auto_Sony_v2/%04d" % epoch):
        continue
    cnt = 0
    if epoch > 2000:
        learning_rate = 1e-5
