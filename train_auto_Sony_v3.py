...
"""
resnet + seblock + branch net

"""

input_dir = './dataset/Sony/short/'
gt_dir = './dataset/Sony/long/'
checkpoint_dir = './result_auto_Sony_v3/'
result_dir = './result_auto_Sony_v3/'
...
def network(input):
    ...
    temp5 = Relu(temp4)
    ratio = Fully_connected(temp5, units=1, layer_name= 'fully_connected2')
    #ratio = min(ratio,300)
...
allfolders = glob.glob('./result_auto_Sony_v3/*0')
lastepoch = 0
...
for epoch in range(lastepoch, 4001):
    ...
    if os.path.isdir("result_auto_Sony_v3/%04d" % epoch):
        continue
    cnt = 0
    if epoch > 2000:
        learning_rate = 1e-5
